...
enum BACnetPropertyIdentifier
{
   ...
   WAS_blank1 =                     18, // Used by VTS, unassigned in 135-2012
   ...
   LIST_OF_SESSION_KEYS =           55, // Removed in version 1 revistion 11
   LOCAL_DATE =                     56,
   LOCAL_TIME =                     57,
   LOCATION =                       58,
   LOW_LIMIT =                      59,
   ...
   OBJECT_TYPE =                    79,
   PROP_OPTIONAL =                  80, // "OPTIONAL" is a reserved keyword in VC++5.0
   OUT_OF_SERVICE =                 81,
   OUTPUT_UNITS =                   82,
   EVENT_PARAMETERS =               83,
   POLARITY =                       84,
   ...
   // Enumeration 194 is unassigned in 135-2012

   INTERVAL_OFFSET =                195,
   LAST_RESTART_REASON =            196,
   LOGGING_TYPE =                   197,

   // Enumerations 198 through 201 are unassigned in 135-2012
   ...
   // Enumerations 216 and 217 are unassigned in 135-2012
   ...
   // Enumerations 223 through 225 are unassigned in 135-2012
   ...
   // Enumerations 236 through 243 are undefined in 135-2012
   ...
   // Enumerations 312 through 316 are undefined in 135-2012
   ...
   // Enumerations 324 through 325 are undefined in 135-2012
   ...
   COVU_PERIOD =                    349,
   COVU_RECIPIENTS =                350,
   EVENT_MESSAGE_TEXTS =            351, // Highest in 135-2010
