...
//        CURRENT_NOTIFY_TIME,                     //129		//Modified by Zhu Zhenhua, 2004-5-11
 ...
 //       PREVIOUS_NOTIFY_TIME,                    //138       //Modified by Zhu Zhenhua, 2004-5-11
	   ...
	   // added Addendum B (135-2004)
		...
		ACCESS_RULES = 251,
		ACCESS_RULES_ENABLE = 252,
		ACCESS_TRANSACTION_EVENTS = 253,
		ACCOMPANIED = 254,
		ACTIVATION_TIME = 255,
		ACTIVE_AUTHENTICATION_POLICY = 256,
		ASSIGNED_ACCESS_RIGHTS = 257,
		AUTHENTICATION_FACTOR_INPUT_LIST = 258,
		AUTHENTICATION_FACTORS = 259,
		AUTHENTICATION_POLICY_LIST = 260,
		AUTHENTICATION_POLICY_NAMES = 261,
		AUTHORIZATION_MODE = 262,
		BELONGS_TO = 263,
		CREDENTIAL_DISABLE = 264,
		CREDENTIAL_STATUS = 265,
		CREDENTIALS = 266,
		CREDENTIALS_IN_ZONE = 267,
		DAYS_REMAINING = 268,
		ENTRY_POINTS = 269,
		EXIT_POINTS = 270,
		EXPIRY_TIME = 271,
		EXTENDED_TIME_ENABLE = 272,
		FAILED_ATTEMPT_EVENTS = 273,
		FAILED_ATTEMPTS = 274,
		FAILED_ATTEMPTS_TIME = 275,
		FORMAT_CLASS_SUPPORTED = 276,
		FORMAT_TYPE = 277,
		LAST_ACCESS_EVENT = 278,
		LAST_ACCESS_POINT = 279,
		LAST_CREDENTIAL_ADDED = 280,
		LAST_CREDENTIAL_ADDED_TIME = 281,
		LAST_CREDENTIAL_REMOVED = 282,
		LAST_CREDENTIAL_REMOVED_TIME = 283,
		LAST_USE_TIME = 284,
		LOCKDOWN = 285,
		LOCKDOWN_RELINQUISH_TIME = 286,
		MASTER_EXEMPTION = 287,
		MAX_FAILED_ATTEMPTS = 288,
		MEMBERS = 289,
		MASTER_POINT = 290,
		NUMBER_OF_AUTHENTICATION_POLICIES = 291,
		OCCUPANCY_COUNT = 293,
		OCCUPANCY_COUNT_ENABLE = 294,
		OCCUPANCY_COUNT_EXEMPTION = 295,
		OCCUPANCY_LOWER_THRESHOLD = 296,
		OCCUPANCY_LOWER_THRESHOLD_ENFORCED = 297,
		OCCUPANCY_STATE = 298,
		OCCUPANCY_UPPER_LIMIT = 299,
		OCCUPANCY_UPPER_LIMIT_ENFORCED = 300,
		PASSBACK_EXEMPTION = 301,
		PASSBACK_MODE = 302,
		PASSBACK_TIMEOUT = 303,
		POSITIVE_ACCESS_RULES = 304,
		READ_STATUS = 305,
		REASON_FOR_DISABLE = 306,
		THREAT_AUTHORITY = 307,
		THREAT_LEVEL = 308,
		TRACE_FLAG = 309,
		TRANSACTION_NOTIFICATION_CLASS = 310,
		USER_EXTERNAL_IDENTIFIER = 311,
		...
		USER_INFORMATION_REFERENCE = 317,
		USER_NAME = 318,
		USER_TYPE = 319,
		USES_REMAINING = 320,
		VENDOR_FORMAT_IDENTIFIER = 321,
		ZONE_FROM = 322,
		ZONE_TO = 323,
