...
STRING_TABLE BACnetPropertyIdentifier[] = {
   ...
   // added addendum b (135-2004)
	...
	"authentication-factor-input-list",
	...
	"occupancy-count-exemption",
	"occupancy-lower-threshold",
	"occupancy-lower-threshold-enforced",
	"occupancy-state",
	"occupancy-upper-limit",
	"occupancy-upper-limit-enforced",		// 300
	"passback-exemption",
	"passback-mode",
	"passback-timeout",
